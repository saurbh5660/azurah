...
import com.live.azurah.databinding.FragmentFreeQuestBinding
...
@AndroidEntryPoint
class FreeQuestFragment : Fragment() {
    private lateinit var binding: FragmentFreeQuestBinding
//    private val loaderDialog by lazy { LoaderDialog(requireActivity()) }
    ...
    override fun onCreateView(
        ...
        binding = FragmentFreeQuestBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
