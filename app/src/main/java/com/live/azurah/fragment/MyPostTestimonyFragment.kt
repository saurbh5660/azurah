...
@AndroidEntryPoint
class MyPostTestimonyFragment : Fragment() {
    private lateinit var binding: FragmentMyPostTestimonyBinding
//    private val loaderDialog by lazy { LoaderDialog(requireActivity()) }
    private val viewModel by viewModels<CommonViewModel>()
    private var testimonyRequestAdapter : MyPostRequestAdapter? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyPostTestimonyBinding.inflate(inflater,container,false)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvTestimony.addOnScrollListener(object : RecyclerView.OnScrollListener() {
    ...
    private fun setRequestAdapter() {
        ...
        testimonyRequestAdapter?.deleteListener = {pos,model ->
            sureDialog(pos, model)
        }
    ...
    private fun sureDialog(pos: Int, model: CommunityForumResponse.Body.Data) {
        ...
        confirmationBinding.tvYes.setOnClickListener {
            ...
            viewModel.deleteTestimony(model.id.toString(),requireActivity()).observe(viewLifecycleOwner){value->
                when (value.status) {
                    Status.SUCCESS -> {
                       LoaderDialog.dismiss()
                        when (value.data) {
